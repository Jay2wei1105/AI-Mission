...
from app.ml_models.energy_model import ChillerEnergyModel
from app.optimization.optimizer import ChillerOptimizer
from app.schemas import OptimizationContext, OptimizationConstraints, OptimizationResult
from app.exceptions import ModelNotTrainedError, ConfigurationError, OptimizationFailedError
from app.core.feature_mapping import get_feature_mapping
...
class HVACService:
    ...
    def optimize(
        ...
        try:
            ...
            from app.optimization.optimizer import OptimizationContext as InternalContext
            from app.optimization.optimizer import OptimizationConstraints as InternalConstraints
